...
def prompt_text(n=2):
    ...
    *   **Clear Markdown Formatting:** Format your response using markdown to higlight the most important words of your question, and guide the user to navigate the text. 
